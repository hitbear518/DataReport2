...
public class LoginActivity extends HttpSubscriberActivity {
    ...
    public void onEvent(HttpResult httpResult) {
        ...
        case LOGIN:
            ...
            break;
        case WAREHOUSE:
            warehousesAvailable((WarehouseResult) httpResult);
            break;
        }
    }
    ...
    private void loginSuccess() {
        ...
        mServerInterface.getWarehouses(new HttpCallback<WarehouseResult>());
    }

    private void warehousesAvailable(WarehouseResult result) {
        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(this).edit();
        editor.putString(ServerInterface.WAREHOUSES, Utils.toJson(result.warehouses)).commit();
        gotoMain();
    }
